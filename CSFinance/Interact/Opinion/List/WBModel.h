...
@property (nonatomic, strong) NSString *tips; ///< 提示，例如"4222条观点"
...
/**
 观点标题
 */
@interface XWOpinionTitle : NSObject
...
@property (nonatomic, assign) int32_t statusesCount; ///< 观点数
...
@property (nonatomic, assign) int32_t urank; ///< 观点等级 (LV)
...
@property (nonatomic, assign) BOOL verified; ///< 观点认证 (大V)
...
@property (nonatomic, strong) NSString *verifiedReason; ///< 观点认证描述
...
@property (nonatomic, strong) XWOpinionTitle *title; ///< 标题栏 (通常为nil)
@property (nonatomic, strong) NSString *picBg; ///< 观点VIP背景图，需要替换 "os7"
...
@property (nonatomic, strong) XWOpinion *retweetedStatus; ///转发观点
...
@property (nonatomic, strong) NSArray<XWOpinion *> *statuses;
/*
 groupInfo
 trends
 */
