...
typedef NS_ENUM(NSUInteger, XWOpinionCardType) {
    XWOpinionCardTypeNone = 0, ///< 没卡片
    XWOpinionCardTypeNormal,   ///< 一般卡片布局
    XWOpinionCardTypeVideo,    ///< 视频
};

/// 最下方Tag类型，也是随便写的，观点可能有更多类型同时存在等情况
typedef NS_ENUM(NSUInteger, XWOpinionTagType) {
    XWOpinionTagTypeNone = 0, ///< 没Tag
    XWOpinionTagTypeNormal,   ///< 文本
    XWOpinionTagTypePlace,    ///< 地点
};
...
@property (nonatomic, assign) XWOpinionCardType retweetCardType;
...
@property (nonatomic, assign) XWOpinionCardType cardType;
...
@property (nonatomic, assign) XWOpinionTagType tagType;
