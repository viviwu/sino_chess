...
@implementation XWOpinionComposeTextParser
...
- (BOOL)parseText:(NSMutableAttributedString *)text selectedRange:(NSRangePointer)selectedRange {
    ...
    
    {
        ...
        dispatch_once(&onceToken, ^{
            ...
            topicExtImages = @[
                [XWOpinionHelper imageNamed:@"timeline_card_small_movie"],
                [XWOpinionHelper imageNamed:@"timeline_card_small_book"],
                [XWOpinionHelper imageNamed:@"timeline_card_small_music"],
                [XWOpinionHelper imageNamed:@"timeline_card_small_location"],
                [XWOpinionHelper imageNamed:@"timeline_card_small_stock"]
            ];
        });
        
        NSArray<NSTextCheckingResult *> *topicResults = [[XWOpinionHelper regexTopic] matchesInString:text.string options:kNilOptions range:text.rangeOfAll];
    ...
    {
        NSArray<NSTextCheckingResult *> *atResults = [[XWOpinionHelper regexAt] matchesInString:text.string options:kNilOptions range:text.rangeOfAll];
